...
from harmonic.d3.conv import HConvTranspose3d
...
class HConvTests(unittest.TestCase):
    def _diff_rotation(self, order, plane):
        ...
        conv1 = HConvTranspose3d(repr1, repr2, s).double()
        conv2 = HConvTranspose3d(repr2, repr1, s).double()
    ...
    def test_equivariance_single_stream(self):
        ...
        cconv1 = HConvTranspose3d(rep1, rep2, s).double()
        cconv2 = HConvTranspose3d(rep2, rep1, s).double()
    ...
    def test_equivariance_multi_stream_two_hops(self):
        ...
        cconv1 = HConvTranspose3d(rep1, rep2, s).double()
        cconv2 = HConvTranspose3d(rep2, rep3, s).double()
        cconv3 = HConvTranspose3d(rep3, rep4, s).double()
